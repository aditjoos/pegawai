...
$.extend(true, $.fn.dataTable.defaults, {
  ...
  "oLanguage": {
     ...
     "sPaginate": {
	        "first": "<i class='fa fa-angle-double-left text-danger'></i>&nbsp;",
	        "previous": "<i class='fa fa-angle-left text-danger'></i>&nbsp;",
	        "next": "<i class='fa fa-angle-right text-danger'></i>&nbsp;",
	        "last": "<i class='fa fa-angle-double-right text-danger'></i>&nbsp;"
	    }
