                        ...
                        <div class="col-lg-8">
                            <div class="panel-body">
                                ...
                                <div class="form-group offset">
                                    <div>
                                        <form action="<?php echo $path; ?>member/update_ajuan/3/<?php if(isset($data)){echo $data->no;}else{echo '-';} ?>" class="form-horizontal" method="POST" id="upload_form" enctype="multipart/form-data" data-collabel="3" data-alignlabel="left">
