		...
		<ul>
				...
				<?php 
					if(strtolower($lvl)=='operator'){
						echo '<li><span><i class="icon  fa fa-sitemap"></i> MENU OPERATOR</span>
											<ul>
					...
					if(strtolower($lvl)=='admin'){
						echo '<li><span><i class="icon  fa fa-sitemap"></i> MENU ADMINISTRATOR</span>
											<ul>
													<li><a href="'.$path.'Member/pivot"><i class="icon  fa fa-eye"></i> Pivot profil pegawai</a></li>
											</ul>
									</li>';
					} 
				?>
