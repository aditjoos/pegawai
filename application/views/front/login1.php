...
<html lang="en">
<head>
<title>Sistem Informasi Manajemen Presensi</title>
<!-- Favicons -->
							...
							?>
								<div class="account-wall">
										...
										<h1 class="login-title">
											<span><?php echo $nama; ?></span></h1><h4> Sistem Informasi Manajemen Presensi</h4>
										</section>
										<form id="form-signin" class="form-signin">
												<section>
														...
														<button class="btn btn-lg btn-primary btn-block" type="submit" id="sign-in">Login</button>
												</section>
										</form>
					...
					$.ajax({
						...
						success: function (e) {
								setTimeout(function () { main.removeClass("slideDown") }, !e.status ? 500:3000);
								 if (!e.status) { 
									 $.notific8(e.message,{ life:5000,horizontalEdge:"top", theme:"danger" ,heading:" Error !! "});
									return false;
								 }
